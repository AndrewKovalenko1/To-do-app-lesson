  ...
  render() {
    return (
      <div className=" dropdown dropdown-main-button">
        ...
        <div
          className={
            "flex-center icon-round text-center bcolor-almost-white dropbtn " +
            (this.props.currentIcon === "plus"
              ? " gray-border-color "
              : " red-border-color ")
          }
        >
          ...
          <FontAwesomeIcon
            ...
            className={
              this.props.currentIcon === "plus" ? "gray-color" : "red-color"
            }
            size="2x"
          />
          <span className="span-center"></span>
        ...
        <div className="dropdown-content dropdown-borders">
          ...
          <ul>
            {this.state.icons.map(icon => (
              <IconItem
                onClick={icon => this.props.handleOnClickIcon(icon)}
                iconName={icon}
                key={icon}
              />
            ))}
